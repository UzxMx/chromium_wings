...
export const ResourceType = Common.ResourceType
export const ResourceCategory = Common.ResourceCategory
export const resourceCategories = Common.resourceCategories
export const resourceTypes = Common.resourceTypes
